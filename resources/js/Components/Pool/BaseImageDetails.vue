...
<template>
    <div class="base-img-details">
        ...
        <input v-model="props.baseImage.name" :placeholder="props.baseImage.name ?? 'No Title'"
            @change="($e : any) => setTitle($e)"></input>

        <label for="link">Link</label>
        <input v-model="props.baseImage.link" :placeholder="props.baseImage.link ?? 'No Link'"
            @change="($e : any) => setLink($e)"></input>
