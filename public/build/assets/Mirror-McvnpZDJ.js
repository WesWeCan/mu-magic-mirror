 ...
 * limitations under the License.
 * =============================================================================
 */function Nh(i,t){if(Math.max(...i)>5)throw new Error("Cannot symbolically compute strides for rank > 6 tensor.");const e=i.length,r="xyzwuv",o=i.map(a=>`${t}.${r[a]}`),n=new Array(e-1);n[e-2]=o[e-1];for(let a=e-3;a>=0;--a)n[a]=`(${n[a+1]} * ${o[a+1]})`;return n}const ot=(i,t,e)=>e==="int32"?`atomicAdd(${i}, bitcast<i32>(${t}));`:`
          {
            var oldValue = 0;
            loop {
 ...
 */var $t;(function(i){i[i.FROM_PIXELS=0]="FROM_PIXELS",i[i.DRAW=1]="DRAW"})($t||($t={}));const Dh=(i,t,e,r,o)=>{const n={dtype:r.dtype,shape:r.shape},a=Fh(e,n,t),u=i.createShaderModule({code:a,label:t.constructor.name});let c=fe().get("WEBGPU_PRINT_SHADER");if(c!==""){c=c.toLowerCase();const h=c.split(",");(c==="all"||h.some(p=>t.shaderKey.toLowerCase().includes(p)))&&(console.group(t.shaderKey),console.debug(a),console.groupEnd())}return o?i.createComputePipelineAsync({compute:{module:u,entryPoint:"_start"},label:t.constructor.name,layout:"auto"}):i.createComputePipeline({compute:{module:u,entryPoint:"_start"},label:t.constructor.name,layout:"auto"})},ee=(i,t="f32")=>{switch(i){case 1:return`${t}`;case 2:return`vec2<${t}>`;case 3:return`vec3<${t}>`;case 4:return`vec4<${t}>`;default:throw new Error(`${i}-component ${t} is not supported.`)}};function de(i){if(i<=1)return"i32";if(i===2)return"vec2<i32>";if(i===3)return"vec3<i32>";if(i===4)return"vec4<i32>";if(i===5)return"vec5";if(i===6)return"vec6";throw Error(`GPU for rank ${i} is not yet supported`)}function qe(i){if(i===0)return"x";if(i===1)return"y";if(i===2)return"z";if(i===3)return"w";if(i===4)return"u";if(i===5)return"v";throw Error(`Index ${i} is not yet supported`)}function M(...i){let t;switch(i.length){case 0:t=`
    ...
    `,e}function Th(i){return`
  @compute @workgroup_size(${i.workgroupSize[0]}, ${i.workgroupSize[1]}, ${i.workgroupSize[2]})
`}function Fh(i,t,e){const r=[],o=e.workgroupSize[0]*e.workgroupSize[1]*e.workgroupSize[2];if(e.outputComponent=e.outputComponent?e.outputComponent:1,r.push(`
...
`)}let n,a,u="struct Uniforms { NAN : f32, INFINITY : f32, ";e.variableNames.forEach((y,w)=>{const b=de(i[w].shape.length);u+=`${y.charAt(0).toLowerCase()+y.slice(1)}Shape : ${b}, `,n=i[w].shape.length-1,a=de(n),u+=`${y.charAt(0).toLowerCase()+y.slice(1)}ShapeStrides: ${a}, `});const c=de(t.shape.length);u+=`outShape : ${c}, `,n=t.shape.length-1,a=de(n),u+=`
         outShapeStrides: ${a}, `,e.size&&(u+="size : i32, "),e.uniforms&&(u+=e.uniforms),u+="};",u=Uh(u),r.push(u),e.atomic?r.push(`
...
`;function Ii(i,t=""){const e=i.length,r=t!==""?`get${t.charAt(0).toUpperCase()+t.slice(1)}CoordsFromIndex`:"getCoordsFromIndex",o=t!==""?`${t.charAt(0).toLowerCase()+t.slice(1)}ShapeStrides`:"outShapeStrides";if(e<=1)return`fn ${r}(index : i32) -> i32 { return index; }`;const n=Zt(i),a=de(e),u=[];for(let h=0;h<e;h++)u.push(`d${h}`);if(n.length===1)return`    fn ${r}(index : i32) -> vec2<i32> {
  ...
  `}function zh(i,t){const e=i.name,r=i.shape.length,o=de(r),n="get"+e.charAt(0).toUpperCase()+e.slice(1),a=["d0","d1","d2","d3","d4","d5"].slice(0,r),u=a.map(p=>`${p} : i32`).join(", ");if(r<1)return`
      fn ${n}() -> ${ee(t)} {
        return ${ee(t)}(${e}[0]);
      }
   ...
   `}function Mh(i,t,e,r){const o=i.name,n=o.charAt(0).toUpperCase()+o.slice(1),a="get"+n+"ByOutput",u=i.shape.length,c=t.length,h=de(c);if(Dt(i.shape,t)&&r)return`
...
`}function Lh(i,t,e,r){let o=zh(i,e);return i.shape.length<=t.length&&(o+=Mh(i,t,e,r)),o}function Oh(i,t){const{x:e,y:r=[],z:o=[]}=t,n=i.length,a=e.length+r.length+o.length;if(a!==n)return"";if(e.length===n)return`fn getOutputCoords() -> ${de(n)}{
  ...
  ${u}
`;return h.length===0?d+=`return ${p}(0); }`:d+=`return ${p}(${h.join(",")}); }`,d}function Bh(i){let t="";switch(i){case 0:case 1:t+=`
    ...
    `}return n}function Uh(i){const t=/(\w+)\s*:\s*vec(5|6)/g;i=i.replace(t,r=>"@align(16) "+r);const e=/vec(5|6)\s*,\s*(\w+)/g;return i=i.replace(e,(r,o,n)=>`vec${o}, @align(16) ${n}`),i}function Xo(i){return!(i.dispatchLayout.hasOwnProperty("y")&&i.dispatchLayout.y.length!==0||i.dispatchLayout.hasOwnProperty("z")&&i.dispatchLayout.z.length!==0)}/**
 * @license
 * Copyright 2019 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
...
`,rd=`
  ...
  let one = sign(b) * 0 + 1;
  let resultTemp = select(zero, one, a <= b);
`,od="return f32(a >= 1.0 && b >= 1.0);",sd=`return (vec4<f32>(a >= vec4<f32>(1.0)) *
  vec4<f32>(b >= vec4<f32>(1.0)));`,nd="return f32(a >= 1.0 || b >= 1.0);",ad=`return min(vec4<f32>(a >= vec4<f32>(1.0)) +
  vec4<f32>(b >= vec4<f32>(1.0)), vec4<f32>(1.0));`,ud="let resultTemp = max(a, b);",ld="let resultTemp = min(a, b);",cd=`
  let isNaN = b == 0.;
  var resultTemp = a % b;
...
`,xd="if (a < 0.0) { return b * a; }  return a;",yd=`
  let aLessThanZero = vec4<f32>(a < vec4<f32>(0.0));
  return (aLessThanZero * (b * a)) + ((vec4<f32>(1.0) - aLessThanZero) * a);
`,wd="let resultTemp = (a - b) * (a - b);",vd="let resultTemp = a - b;";function Fr(i,t){let e;do{switch(i){case K.ATAN2:e=Xh;break;case K.MAX:e=ud;break;case K.MIN:e=ld;break;case K.MOD:e=t?hd:cd;break;case K.NOT_EQUAL:e=t?fd:pd;break;case K.POW:e=t?gd:md;break;default:continue}let r,o,n;return t?(r="isnanVec4",o="vec4<f32>",n="vec4<bool>"):(r="isnan",o="f32",n="bool"),`
      let aIsNaN = ${r}(a);
    ...
    `}while(!1);switch(i){case K.ADD:e=jh;break;case K.COMPLEX_MULTIPLY_IMAG:e=Yh;break;case K.COMPLEX_MULTIPLY_REAL:e=Kh;break;case K.DIV:e=qh;break;case K.ELU_DER:e=Qh;break;case K.EQUAL:e=Zh;break;case K.FLOOR_DIV:e=Jh;break;case K.GREATER:e=ed;break;case K.GREATER_EQUAL:e=td;break;case K.LESS:e=id;break;case K.LESS_EQUAL:e=rd;break;case K.LOGICAL_AND:return t?sd:od;case K.LOGICAL_OR:return t?ad:nd;case K.MUL:e=dd;break;case K.PRELU:return t?yd:xd;case K.SQUARED_DIFFERENCE:e=wd;break;case K.SUB:e=vd;break}return`
    ${e}
    return resultTemp;
  `}/**
 * @license
...
`,Pd=`
  ...
  return atanh(a);
`,Ad="return ceil(a);",$d="return cos(a);",Nd=`
  let e2x = exp(-a);
  return (e2x + 1.0 / e2x) / 2.0;
`,Dd="return exp(a) - 1.0;",Td="if (a >= 0.0) { return a; }  return (exp(a) - 1.0);",Fd=`
...
`,_d="return exp(a);",zd="return floor(a);",Md="return f32(!isnan(a) && !isinf(a));",Ld="return f32(isinf(a));",Od="return f32(isnan(a));",Bd="return a;",Wd=`if (a < 0.0) { return uniforms.NAN; }
  return log(a);`,Ud=`
  if (isnan(a)) { return a; }
  return log(1.0 + a);
`,Vd="return f32(!(a >= 1.0));",Gd="return -a;",Hd="if (a < 0.0) { return uniforms.alpha * a; } return a;",jd=`
  let aLessThanZero = vec4<f32>(a < vec4<f32>(0.0));
  return (aLessThanZero * (uniforms.alpha * a)) + ((vec4<f32>(1.0) - aLessThanZero) * a);
`,Xd="return 1.0 / a;",Kd="return select(a, 0.0, a < 0.0);",Yd="return clamp(a, 0.0, 6.0);",qd="return clamp(a, vec4<f32>(0.0, 0.0, 0.0, 0.0), vec4<f32>(6.0, 6.0, 6.0, 6.0));",Qd=`
  return select(a, vec4<f32>(0.0), a < vec4<f32>(0.0));
`,Zd="return round(a);",Jd="return inverseSqrt(a);",ep=`
  if (a >= 0.0) {
    return ${Va} * a;
  } else {
    return ${Ga} * (exp(a) - 1.0);
  }
`,tp="return 1.0 / (1.0 + exp(-1.0 * a));",ip="return sign(a);",rp="return sin(a);",op=`
  let e2x = exp(a);
  return (e2x - 1.0 / e2x) / 2.0;
`,sp=`
...
`,np="return sqrt(a);",ap="return a * a;",up=`
  if (isnan(a)) {
    return a;
  }
...
`,hp="return f32(i32((a)));";function lt(i,t){switch(i){case z.ABS:return Cd;case z.ACOS:return bd;case z.ACOSH:return Sd;case z.ASIN:return kd;case z.ASINH:return Id;case z.ATAN:return Rd;case z.ATANH:return Pd;case z.COS:return $d;case z.COSH:return Nd;case z.CEIL:return Ad;case z.ELU:return t?Fd:Td;case z.ERF:return Ed;case z.EXP:return _d;case z.EXPM1:return Dd;case z.FLOOR:return zd;case z.IS_FINITE:return Md;case z.IS_INF:return Ld;case z.IS_NAN:return Od;case z.LINEAR:return Bd;case z.LOG:return Wd;case z.LOG1P:return Ud;case z.LOGICAL_NOT:return Vd;case z.NEG:return Gd;case z.LEAKYRELU:return t?jd:Hd;case z.RECIPROCAL:return Xd;case z.RELU:return t?Qd:Kd;case z.RELU6:return t?qd:Yd;case z.ROUND:return Zd;case z.RSQRT:return Jd;case z.SELU:return ep;case z.SIGMOID:return tp;case z.SIGN:return ip;case z.SIN:return rp;case z.SINH:return op;case z.SOFTPLUS:return sp;case z.SQRT:return np;case z.SQUARE:return ap;case z.STEP:return up;case z.TAN:return lp;case z.TANH:return cp;case z.TO_INT:return hp;default:throw new Error(`BinaryType ${i} is not implemented!`)}}/**
 * @license
 * Copyright 2021 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 */function Xs(i,t,e=!1,r=!1,o=!1,n=1){ne(i&&n===1||!i,()=>`transposeA ${i} is not compatible with component size ${n}`);const a=`
  ...
  `;function gp(i,t=!1){ne(i[1]===1&&i[2]===1,()=>`A linear work group size is required. But got ${i}.`);const e=i[0]*4;return`
  ...
  `}class xp{constructor(t,e,r=!1,o=!1,n=null,a=null,u=null,c=!1){this.variableNames=["A","B"],this.uniforms="dimAOuter : i32, dimBOuter : i32, dimInner : i32,",this.outputShape=e,this.dispatchLayout={x:[2],y:[1],z:[0]};const h=r?t[1]:t[2];if(this.isVec4=(h%4===0&&!r||e[1]%4===0&&r)&&e[2]%4===0&&!o,this.outputComponent=this.isVec4?4:1,this.isVectorA=e[1]===1&&!r,!this.isVec4&&this.isVectorA)this.elementsPerThread=[1,1,1],this.workgroupSize=[32,1,1];else{const m=Vh(e[1],h,e[2],r);this.workgroupSize=m.workgroupSize,this.elementsPerThread=m.elementsPerThread}this.dispatch=L(this.dispatchLayout,this.outputShape,this.workgroupSize,this.elementsPerThread);const p=n!=null,d=u!=null;p&&this.variableNames.push("bias"),d&&this.variableNames.push("preluActivationWeights"),this.sequentialAccessByThreads=c,this.transposeA=r,this.transposeB=o,this.addBias=p,this.activation=a,this.hasPreluActivationWeights=d,[this.fitAOuter,this.fitBOuter,this.fitInner]=this.getShapeFit(e[1],e[2],h),this.shaderKey=`matMulPacked_${this.elementsPerThread}_${r}_${o}_${this.activation}_${this.fitAOuter}_${this.fitBOuter}_${this.fitInner}_${this.isVec4}_${this.isVectorA}_${this.sequentialAccessByThreads}`}getShapeFit(t,e,r){const o=this.workgroupSize[1]*this.elementsPerThread[1],n=this.workgroupSize[0]*this.elementsPerThread[0];!this.isVec4&&this.isVectorA?this.tileInner=this.workgroupSize[0]*4:this.tileInner=n;const a=t%o===0,u=e%n===0,c=r%this.tileInner===0;return[a,u,c]}getUserCode(){return`
      ...
      ${this.isVec4?Di(this.elementsPerThread,this.workgroupSize,this.transposeA,this.tileInner,!1,null,!0):this.isVectorA?gp(this.workgroupSize,this.transposeA):Ti(this.elementsPerThread,this.workgroupSize,this.transposeA,this.tileInner,!1,null,this.sequentialAccessByThreads,!0)}
    `}}/**
 * @license
 * Copyright 2021 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * limitations under the License.
 * =============================================================================
 */function vp(i){const t=i[1],e=i[0],r=t>e?t:e;return`
 ...
 * limitations under the License.
 * =============================================================================
 */class kp{constructor(t){this.variableNames=[],this.outputShape=[],this.uniforms="value : f32,",this.workgroupSize=[64,1,1],this.size=!0,this.outputShape=t,this.dispatchLayout=U(this.outputShape),this.dispatch=L(this.dispatchLayout,this.outputShape,this.workgroupSize),this.shaderKey="fill"}getUserCode(){return`
    ${M("index")} {
      if (index < uniforms.size) {
 ...
 * limitations under the License.
 * =============================================================================
 */function $e(i){const{backend:t,attrs:e}=i,{shape:r,value:o}=e;let{dtype:n}=e;if(n=n||ja(o),n==="string"){const a=Xa(n,J(r));return a.fill(o),t.makeTensorInfo(r,n,a)}else{const a=new kp(r),u=[{type:"float32",data:[o]}];return t.runWebGPUProgram(a,[],n,u)}}const Ip={kernelName:Ha,backendName:"webgpu",kernelFunc:$e};/**
 * @license
 * Copyright 2021 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function Pp(i){const{inputs:t,backend:e,attrs:r}=i,{a:o,b:n,bias:a,preluActivationWeights:u}=t,{transposeA:c,transposeB:h,activation:p,leakyreluAlpha:d}=r;return Fi({a:o,b:n,transposeA:c,transposeB:h,backend:e,bias:a,preluActivationWeights:u,leakyreluAlpha:d,activation:p})}const Ap={kernelName:qa,backendName:"webgpu",kernelFunc:Pp};/**
 * @license
 * Copyright 2021 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function Ee(i){const{inputs:t}=i,{x:e}=t;return i.backend.incRef(e.dataId),{dataId:e.dataId,shape:e.shape,dtype:e.dtype}}const $p={kernelName:Qa,backendName:"webgpu",kernelFunc:Ee};/**
 * @license
 * Copyright 2021 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function gt(i){const{inputs:t,backend:e}=i,{real:r,imag:o}=t,n=e.makeTensorInfo(r.shape,"complex64"),a=e.tensorMap.get(n.dataId),u=Ee({inputs:{x:r},backend:e}),c=Ee({inputs:{x:o},backend:e});return a.complexTensorInfos={real:u,imag:c},n}const Np={kernelName:Za,backendName:"webgpu",kernelFunc:gt};/**
 * @license
 * Copyright 2019 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */const{addImpl:Dp,castImpl:Tp,ceilImpl:Fp,concatImpl:Ep,equalImpl:_p,expImpl:zp,expm1Impl:Mp,floorImpl:Lp,floorDivImpl:Op,gatherNdImpl:Bp,gatherV2Impl:Wp,greaterEqualImpl:Up,greaterImpl:Vp,lessEqualImpl:Gp,lessImpl:Hp,logImpl:jp,maxImpl:Xp,maximumImpl:Kp,minimumImpl:Yp,multiplyImpl:qp,negImpl:Qp,notEqualImpl:Zp,prodImpl:Jp,rangeImpl:ef,rsqrtImpl:tf,scatterImpl:rf,simpleAbsImpl:of,sliceImpl:sf,stridedSliceImpl:nf,stringNGramsImpl:af,subImpl:uf,tileImpl:lf,topKImpl:cf,transposeImpl:hf,uniqueImpl:f0}=Ja;/**
 * @license
 * Copyright 2021 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */const df=se({opType:z.ABS,cpuKernelImpl:of}),pf={kernelName:eu,backendName:"webgpu",kernelFunc:df};/**
 * @license
 * Copyright 2022 Google LLC.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */const ff=se({opType:z.ACOS}),mf={kernelName:tu,backendName:"webgpu",kernelFunc:ff};/**
 * @license
 * Copyright 2022 Google LLC.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */const gf=se({opType:z.ACOSH}),xf={kernelName:iu,backendName:"webgpu",kernelFunc:gf};/**
 * @license
 * Copyright 2021 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */const yf=ye({opType:K.ADD,cpuKernelImpl:Dp,supportsComplex:!0}),wf={kernelName:ru,backendName:"webgpu",kernelFunc:yf};/**
 * @license
 * Copyright 2021 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function Cf(i){const{inputs:t,backend:e}=i,r=t;if(r.length===1)return Ee({inputs:{x:r[0]},backend:e});const o=r.map(u=>u.dtype).reduce((u,c)=>Jt(u,c)),n=r.map(u=>u.shape),a=new vf(n);return e.runWebGPUProgram(a,r,o)}const bf={kernelName:ou,backendName:"webgpu",kernelFunc:Cf};/**
 * @license
 * Copyright 2019 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */class kf{constructor(t,e){this.variableNames=["A"],this.workPerThread=1,this.workgroupSize=[64,1,1],this.size=!0;const r=new Array(t.length);for(let o=0;o<r.length;o++)r[o]=t[e[o]];this.outputShape=r,this.dispatchLayout=U(this.outputShape),this.dispatch=L(this.dispatchLayout,this.outputShape,this.workgroupSize,[this.workPerThread,1,1]),this.newDim=e,this.shaderKey=`transpose_${e}`}getUserCode(){const t=de(this.outputShape.length),e=Ks(this.newDim);return`
      ${M("index")} {
        for(var i = 0; i < ${this.workPerThread}; i = i + 1) {
          let flatIndex = index * ${this.workPerThread} + i;
          if(flatIndex < uniforms.size) {
 ...
 * limitations under the License.
 * =============================================================================
 */function Xe(i){const{inputs:t,backend:e,attrs:r}=i,{x:o}=t,{perm:n}=r,a=e,u=o.shape.length,c=new Array(u);for(let p=0;p<c.length;p++)c[p]=o.shape[n[p]];if(e.shouldExecuteOnCPU([o])){const d=a.tensorMap.get(o.dataId).values,m=hf(d,o.shape,o.dtype,n,c);return e.makeTensorInfo(c,o.dtype,m)}if(o.shape.length===2&&Dt(n,[1,0])){const p=new Sf(o.shape,n);return a.runWebGPUProgram(p,[o],o.dtype)}const h=new kf(o.shape,n);return a.runWebGPUProgram(h,[o],o.dtype)}const If={kernelName:su,backendName:"webgpu",kernelFunc:Xe};/**
 * @license
 * Copyright 2019 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */const Pf={mean:"float32",all:"bool",any:"bool"};function xt(i,t,e,r,o){const n=i.shape.length,a=[],u=ft(t,i.shape);let c=u;const h=ai(c,n);let p=i;h!=null&&(p=Xe({inputs:{x:i},attrs:{perm:h},backend:o}),c=ui(c.length,n),a.push(p)),Pr(r,c,n);const[d,m]=Rr(p.shape,c);let x=d;e&&(x=nu(d,u));let y;if((r==="max"||r==="prod")&&o.shouldExecuteOnCPU([p])){const w=o.tensorMap.get(p.dataId).values;switch(r){case"max":const b=Xp(w,J(m),x,i.dtype);y=o.makeTensorInfo(x,i.dtype,b);break;case"prod":const{outVals:I,outShape:R,outDtype:P}=Jp(p.shape,p.dtype,w,c);y=o.makeTensorInfo(R,P,I);break;default:throw new Error(`${r} CPU implementation is not yet supported.`)}}else{const w=J(m),I=J(p.shape)/w,R={windowSize:w,inSize:w,batchSize:I,outSize:1},P=Pf[r]||au(i.dtype),A=[{type:"int32",data:[w]}],N=new Rf(R,r,o.device.limits.maxComputeWorkgroupSizeX),D=o.runWebGPUProgram(N,[p],P,A);a.push(D),y=H({inputs:{x:D},attrs:{shape:x},backend:o})}return a.forEach(w=>o.disposeData(w.dataId)),y}/**
 * @license
 * Copyright 2022 Google LLC.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function Af(i){const{inputs:t,backend:e,attrs:r}=i,{x:o}=t,{keepDims:n,axis:a}=r;return xt(o,a,n,"all",e)}const $f={kernelName:uu,backendName:"webgpu",kernelFunc:Af};/**
 * @license
 * Copyright 2022 Google LLC.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function Nf(i){const{inputs:t,backend:e,attrs:r}=i,{x:o}=t,{keepDims:n,axis:a}=r;return xt(o,a,n,"any",e)}const Df={kernelName:lu,backendName:"webgpu",kernelFunc:Nf};/**
 * @license
 * Copyright 2019 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function Tf(i){const{inputs:t,backend:e,attrs:r}=i,{x:o}=t,{axis:n}=r;let a=ft(n,o.shape);const u=ai(a,o.shape.length);let c=o;const h=[];u!=null&&(c=Xe({inputs:{x:o},backend:e,attrs:{perm:u}}),h.push(c),a=ui(a.length,c.shape.length)),Pr("argMax",[a[0]],c.shape.length);const p=new Ys(c.shape,a[0],"max"),d=[{type:"float32",data:[Number.NEGATIVE_INFINITY]}],m=e.runWebGPUProgram(p,[c],"int32",d);return h.forEach(x=>e.disposeData(x.dataId)),m}const Ff={kernelName:cu,backendName:"webgpu",kernelFunc:Tf};/**
 * @license
 * Copyright 2021 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function Ef(i){const{inputs:t,backend:e,attrs:r}=i,{x:o}=t,{axis:n}=r;let a=ft(n,o.shape);const u=ai(a,o.shape.length);let c=o;const h=[];u!=null&&(c=Xe({inputs:{x:o},backend:e,attrs:{perm:u}}),h.push(c),a=ui(a.length,c.shape.length)),Pr("argMin",[a[0]],c.shape.length);const p=new Ys(c.shape,a[0],"min"),d=[{type:"float32",data:[Number.POSITIVE_INFINITY]}],m=e.runWebGPUProgram(p,[c],"int32",d);return h.forEach(x=>e.disposeData(x.dataId)),m}const _f={kernelName:hu,backendName:"webgpu",kernelFunc:Ef};/**
 * @license
 * Copyright 2022 Google LLC.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */const zf=se({opType:z.ASIN}),Mf={kernelName:du,backendName:"webgpu",kernelFunc:zf};/**
 * @license
 * Copyright 2022 Google LLC.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */const Lf=se({opType:z.ASINH}),Of={kernelName:pu,backendName:"webgpu",kernelFunc:Lf};/**
 * @license
 * Copyright 2022 Google LLC.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */const Bf=se({opType:z.ATAN}),Wf={kernelName:fu,backendName:"webgpu",kernelFunc:Bf};/**
 * @license
 * Copyright 2022 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */const Uf=ye({opType:K.ATAN2}),Vf={kernelName:mu,backendName:"webgpu",kernelFunc:Uf};/**
 * @license
 * Copyright 2022 Google LLC.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */const Gf=se({opType:z.ATANH}),Hf={kernelName:gu,backendName:"webgpu",kernelFunc:Gf};/**
 * @license
 * Copyright 2021 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function qs(i){const{inputs:t,backend:e,attrs:r}=i,{x:o}=t,{reductionIndices:n,keepDims:a}=r;return xt(o,n,a,"max",e)}const Xf={kernelName:xu,backendName:"webgpu",kernelFunc:qs};/**
 * @license
 * Copyright 2021 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function Qs(i){const{inputs:t,backend:e,attrs:r}=i,{x:o}=t,{keepDims:n,axis:a}=r;return xt(o,a,n,"mean",e)}const Kf={kernelName:yu,backendName:"webgpu",kernelFunc:Qs};/**
 * @license
 * Copyright 2022 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function Yf(i){const{inputs:t,backend:e,attrs:r}=i,{x:o}=t,{filterSize:n,strides:a,pad:u,dimRoundingMode:c}=r,p=li(o.shape,n,a,1,u,c);return Zs(o,p,"avg",e)}const qf={kernelName:wu,backendName:"webgpu",kernelFunc:Yf};/**
 * @license
 ...
 * limitations under the License.
 * =============================================================================
 */class Jf{constructor(t){this.variableNames=["dy"],this.uniforms=`strides : vec2<i32>, pads : vec2<i32>, dilations : vec2<i32>, filterDims : vec2<i32>,
    ...
    `}}class em{constructor(t){this.variableNames=["dy"],this.uniforms=`strides : vec3<i32>, pads : vec3<i32>, filterDims : vec3<i32>,
 ...
 * limitations under the License.
 * =============================================================================
 */function tm(i){const{inputs:t,backend:e,attrs:r}=i,{dy:o,input:n}=t,a=n,{filterSize:u,strides:c,pad:h,dimRoundingMode:p}=r,d=Ni(a.shape,u,c,1,h,p),m=new em(d),x=1/(d.filterDepth*d.filterHeight*d.filterWidth),y=[{type:"int32",data:[d.strideDepth,d.strideHeight,d.strideWidth]},{type:"int32",data:[d.effectiveFilterDepth-1-d.padInfo.front,d.effectiveFilterHeight-1-d.padInfo.top,d.effectiveFilterWidth-1-d.padInfo.left]},{type:"int32",data:[d.effectiveFilterDepth,d.effectiveFilterHeight,d.effectiveFilterWidth]},{type:"int32",data:[d.outDepth]},{type:"int32",data:[d.outHeight]},{type:"int32",data:[d.outWidth]},{type:"float32",data:[x]}];return e.runWebGPUProgram(m,[o],a.dtype,y)}const im={kernelName:Cu,backendName:"webgpu",kernelFunc:tm};/**
 * @license
 * Copyright 2022 Google LLC.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function rm(i){const{inputs:t,backend:e,attrs:r}=i,{dy:o,input:n}=t,a=n;js([o,n],"avgPoolGrad");const{filterSize:u,strides:c,pad:h}=r,p=li(a.shape,u,c,1,h),d=new Jf(p),m=1/(p.filterHeight*p.filterWidth),x=[{type:"int32",data:[p.strideHeight,p.strideWidth]},{type:"int32",data:[p.effectiveFilterHeight-1-p.padInfo.top,p.effectiveFilterWidth-1-p.padInfo.left]},{type:"int32",data:[p.dilationHeight,p.dilationWidth]},{type:"int32",data:[p.effectiveFilterHeight,p.effectiveFilterWidth]},{type:"int32",data:[p.outHeight]},{type:"int32",data:[p.outWidth]},{type:"float32",data:[m]}];return e.runWebGPUProgram(d,[o],a.dtype,x)}const om={kernelName:bu,backendName:"webgpu",kernelFunc:rm};/**
 * @license
 * Copyright 2021 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function sm(i){const{inputs:t,backend:e,attrs:r}=i,{a:o,b:n}=t,{transposeA:a,transposeB:u}=r;return Fi({a:o,b:n,transposeA:a,transposeB:u,backend:e})}const nm={kernelName:Su,backendName:"webgpu",kernelFunc:sm};/**
 * @license
 * Copyright 2019 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
...
`)}
    ...
    `}}const yr=["x","y","z","w","u","v"];function um(i){if(i===1)return"sourceLoc";if(i<=6)return yr.slice(0,i).map(t=>`sourceLoc.${t}`).join(",");throw Error(`Slicing for rank ${i} is not yet supported`)}/**
 * @license
 * Copyright 2021 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function _t(i){const{inputs:t,backend:e,attrs:r}=i,{x:o}=t,{begin:n,size:a}=r,[u,c]=Iu(o,n,a);if(Ru(o,u,c),e.shouldExecuteOnCPU([o])||o.dtype==="string"){const d=e.tensorMap.get(o.dataId),m=sf(d.values,u,c,o.shape,o.dtype);return e.makeTensorInfo(c,o.dtype,m)}if(J(c)===0)return e.makeTensorInfo(c,o.dtype,[]);const h=new am(u,c),p=[{type:"int32",data:u}];return e.runWebGPUProgram(h,[o],o.dtype,p)}const lm={kernelName:ku,backendName:"webgpu",kernelFunc:_t};/**
 * @license
 * Copyright 2021 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */const cm=i=>{const{inputs:t,backend:e,attrs:r}=i,{x:o}=t,{blockShape:n,crops:a}=r;ne(o.shape.length<=4,()=>"batchToSpaceND for rank > 4 with a WebGPU backend not implemented yet");const u=n.reduce((R,P)=>R*P),c=_s(o.shape,n,u),h=zs(c.length,n.length),p=Ms(o.shape,n,u),d=Au(a,n.length),m=$u(p,a,n.length),x=[],y=H({inputs:{x:o},backend:e,attrs:{shape:c}}),w=Xe({inputs:{x:y},backend:e,attrs:{perm:h}}),b=H({inputs:{x:w},backend:e,attrs:{shape:p}}),I=_t({inputs:{x:b},backend:e,attrs:{begin:d,size:m}});return x.push(y),x.push(w),x.push(b),x.forEach(R=>e.disposeData(R.dataId)),I},hm={kernelName:Pu,backendName:"webgpu",kernelFunc:cm};/**
 * @license
 * Copyright 2022 Google LLC.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function fm(i){const{inputs:t,backend:e,attrs:r}=i,{x:o,weights:n}=t,{size:a}=r,u=J(o.shape),h=J(n.shape)>0,p=[a],d=n.dtype,m=$e({backend:e,attrs:{shape:p,value:0,dtype:d}}),x=new Js([u],h),y=[{type:"int32",data:[a]}],w=h?[o,n]:[o];return e.runWebGPUProgram(x,w,d,y,m)}const mm={kernelName:Nu,backendName:"webgpu",kernelFunc:fm};/**
 * @license
 * Copyright 2023 Google LLC.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */class gm{constructor(t){this.outputShape=[],this.variableNames=["s0","s1"],this.uniforms="s0Size : i32, s1Size : i32, ",this.workgroupSize=[64,1,1],this.size=!0,this.outputShape=[t],this.dispatchLayout=U(this.outputShape),this.dispatch=L(this.dispatchLayout,this.outputShape,this.workgroupSize),this.shaderKey="broadcastArgs"}getUserCode(){return`
  ${M("index")} {
    if (index < uniforms.size) {
      var s0 = 1.0;
      var s1 = 1.0;
 ...
 * limitations under the License.
 * =============================================================================
 */function xm(i){const{inputs:t,backend:e}=i,{s0:r,s1:o}=t;if(e.shouldExecuteOnCPU([r,o])){const p=e.tensorMap.get(r.dataId),d=e.tensorMap.get(o.dataId),m=p.values,x=d.values,y=et(Array.from(m),Array.from(x));return e.makeTensorInfo([y.length],"int32",Int32Array.from(y))}const n=J(r.shape),a=J(o.shape),u=Math.max(n,a),c=new gm(u),h=[{type:"int32",data:[n]},{type:"int32",data:[a]}];return e.runWebGPUProgram(c,[r,o],"int32",h)}const ym={kernelName:Du,backendName:"webgpu",kernelFunc:xm};/**
 * @license
 * Copyright 2021 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */const en=ye({opType:K.NOT_EQUAL,dtype:"bool",cpuKernelImpl:Zp}),wm={kernelName:Tu,backendName:"webgpu",kernelFunc:en};/**
 * @license
 * Copyright 2021 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function hi(i){const{inputs:t,backend:e}=i,{input:r}=t,o=e.tensorMap.get(r.dataId);return Ee({inputs:{x:o.complexTensorInfos.real},backend:e})}const vm={kernelName:Fu,backendName:"webgpu",kernelFunc:hi};/**
 * @license
 * Copyright 2021 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function Cm(i,t){const e=new Et(i.shape,z.TO_INT),r=t.runWebGPUProgram(e,[i],"int32");return{dataId:r.dataId,shape:r.shape,dtype:r.dtype}}/**
 * @license
 * Copyright 2021 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */const Sm=se({opType:z.CEIL,cpuKernelImpl:Fp}),km={kernelName:zu,backendName:"webgpu",kernelFunc:Sm};/**
 * @license
 ...
 * limitations under the License.
 * =============================================================================
 */class Im{constructor(t){this.variableNames=["A"],this.uniforms="minVal : f32, maxVal : f32,",this.workPerThread=4,this.workgroupSize=[64,1,1],this.outputComponent=4,this.size=!0,this.outputShape=t,this.dispatchLayout=U(this.outputShape),this.dispatch=L(this.dispatchLayout,this.outputShape,this.workgroupSize,[this.workPerThread,1,1]),this.shaderKey="clipVec4"}getUserCode(){return`
      ${M("index")} {
        if(index < uniforms.size) {
 ...
 * limitations under the License.
 * =============================================================================
 */class Rm{constructor(t){this.variableNames=["A"],this.uniforms="minVal : f32, maxVal : f32,",this.workgroupSize=[64,1,1],this.size=!0,this.outputShape=t,this.dispatchLayout=U(this.outputShape),this.dispatch=L(this.dispatchLayout,this.outputShape,this.workgroupSize),this.shaderKey="clip"}getUserCode(){return`
      ${M("index")} {
        if(index < uniforms.size) {
          let value = getAByOutputIndex(index);
          if (isnan(value)) {
 ...
 * limitations under the License.
 * =============================================================================
 */function Pm(i){const{inputs:t,backend:e,attrs:r}=i,{x:o}=t,{clipValueMin:n,clipValueMax:a}=r;let u;const c=[{type:"float32",data:[n]},{type:"float32",data:[a]}];return J(o.shape)%4===0?u=new Im(o.shape):u=new Rm(o.shape),e.runWebGPUProgram(u,[o],o.dtype,c)}const Am={kernelName:Mu,backendName:"webgpu",kernelFunc:Pm};/**
 * @license
 * Copyright 2023 Google LLC.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function Qo(i,t){return{dataId:t.dataId,dtype:t.dtype,shape:i.shape}}function Nm(i){const{inputs:t,backend:e}=i,{x:r}=t,o=e.tensorMap.get(r.dataId),n=new $m(r.shape),a=[Qo(r,o.complexTensorInfos.real),Qo(r,o.complexTensorInfos.imag)];return e.runWebGPUProgram(n,a,a[0].dtype)}const Dm={kernelName:Lu,backendName:"webgpu",kernelFunc:Nm};/**
 * @license
 * Copyright 2019 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function Ei(i){const{inputs:t,backend:e}=i,{input:r}=t,o=e.tensorMap.get(r.dataId);return Ee({inputs:{x:o.complexTensorInfos.imag},backend:e})}const Fm={kernelName:Ou,backendName:"webgpu",kernelFunc:Ei};/**
 * @license
 * Copyright 2021 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function Yt(i,t,e){const r=i[0].dtype;if(r==="complex64"){const y=i.map(P=>hi({inputs:{input:P},backend:e})),w=i.map(P=>Ei({inputs:{input:P},backend:e})),b=Yt(y,t,e),I=Yt(w,t,e),R=gt({inputs:{real:b,imag:I},backend:e});return y.forEach(P=>e.disposeData(P.dataId)),w.forEach(P=>e.disposeData(P.dataId)),e.disposeData(b.dataId),e.disposeData(I.dataId),R}let o=e.shouldExecuteOnCPU(i);if(r==="string"&&(o=!0),o){const y=i.map(N=>{const T=[-1,J(N.shape.slice(t))];return H({inputs:{x:N},backend:e,attrs:{shape:T}})}),w=y.map(N=>({vals:e.readSync(N.dataId),shape:N.shape})),b=ei(y.map(N=>N.shape),1),I=y[0].shape[0]===1,R=Ep(w,b,r,I),P=ei(i.map(N=>N.shape),t),A=e.makeTensorInfo(P,r,R);return y.forEach(N=>e.disposeData(N.dataId)),A}const n=e.device.limits.maxStorageBuffersPerShaderStage-1;if(i.length>n){const y=[];for(let b=0;b<i.length;b+=n){const I=i.slice(b,b+n);y.push(Yt(I,t,e))}const w=Yt(y,t,e);for(const b of y)e.disposeData(b.dataId);return w}const{tensors2D:a,outShape:u}=Em(i,t,e),c=a.map(y=>y.shape),h=new Tm(c),p=[],d=new Array(c.length-1);if(d.length>0){d[0]=c[0][1],p.push({type:"int32",data:[d[0]]});for(let y=1;y<d.length;y++)d[y]=d[y-1]+c[y][1],p.push({type:"int32",data:[d[y]]})}const m=e.runWebGPUProgram(h,a,a[0].dtype,p);a.forEach(y=>e.disposeData(y.dataId));const x=H({inputs:{x:m},backend:e,attrs:{shape:u}});return e.disposeData(m.dataId),x}function Em(i,t,e){const r=ei(i.map(n=>n.shape),t);return{tensors2D:i.map(n=>H({inputs:{x:n},backend:e,attrs:{shape:[J(n.shape.slice(0,t)),J(n.shape.slice(t))]}})),outShape:r}}/**
 * @license
 * Copyright 2021 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function Pi(i,t){const e=i.length;return e>=3?t?[...i.slice(0,-3),i[e-3]*i[e-2],i[e-1]]:[...i.slice(0,-3),i[e-3],i[e-2]*i[e-1]]:!t&&e===1&&i[0]>1?[i[0],1]:null}function Bm({x:i,filter:t,convInfo:e,backend:r,bias:o=null,preluActivationWeights:n=null,leakyreluAlpha:a=0,activation:u=null}){const c=e.dataFormat==="channelsLast",h=!c,p=!1,d=c&&e.filterHeight===e.inHeight&&e.filterWidth===e.inWidth&&e.padInfo.type==="VALID",m=[];let x,y;if(d){const I=e.inHeight*e.inWidth*e.inChannels;x=H({inputs:{x:i},backend:r,attrs:{shape:[1,e.batchSize,I]}}),y=H({inputs:{x:t},backend:r,attrs:{shape:[1,I,e.outChannels]}})}else x=H({inputs:{x:i},backend:r,attrs:{shape:c?[e.batchSize,e.inHeight*e.inWidth,e.inChannels]:[e.batchSize,e.inChannels,e.inHeight*e.inWidth]}}),y=H({inputs:{x:t},backend:r,attrs:{shape:[1,e.inChannels,e.outChannels]}});if(m.push(x),m.push(y),n!=null){const I=Pi(n.shape,c);I!=null&&(n=H({inputs:{x:n},backend:r,attrs:{shape:I}}),m.push(n))}if(o!=null){const I=Pi(o.shape,c);I!=null&&(o=H({inputs:{x:o},backend:r,attrs:{shape:I}}),m.push(o))}const w=Fi({a:c?x:y,b:c?y:x,transposeA:h,transposeB:p,backend:r,bias:o,activation:u,preluActivationWeights:n,leakyreluAlpha:a}),b=H({inputs:{x:w},backend:r,attrs:{shape:e.outShape}});m.push(w);for(const I of m)r.disposeData(I.dataId);return b}function Wm({x:i,filter:t,convInfo:e,backend:r,bias:o=null,preluActivationWeights:n=null,leakyreluAlpha:a=0,activation:u=null}){const{filterWidth:c,filterHeight:h,inChannels:p,strideWidth:d,strideHeight:m,padInfo:x,outWidth:y,outHeight:w,dilationWidth:b,dilationHeight:I,dataFormat:R}=e,P=R==="channelsLast",A=c*h*p,N=w*y,D=P?[e.batchSize,N,A]:[e.batchSize,A,N],T=new Om(D,P),E=[{type:"int32",data:[x.top,x.left]},{type:"int32",data:[m,d]},{type:"int32",data:[I,b]},{type:"int32",data:[y]},{type:"int32",data:[p*c]},{type:"int32",data:[p]}],F=r.runWebGPUProgram(T,[i],i.dtype,E),W=[];W.push(F);const B=H({inputs:{x:t},backend:r,attrs:{shape:[1,A,-1]}});if(W.push(B),n!=null){const ie=Pi(n.shape,P);ie!=null&&(n=H({inputs:{x:n},backend:r,attrs:{shape:ie}}),W.push(n))}if(o!=null){const ie=Pi(o.shape,P);ie!=null&&(o=H({inputs:{x:o},backend:r,attrs:{shape:ie}}),W.push(o))}const Q=Fi({a:P?F:B,b:P?B:F,transposeA:!P,transposeB:!1,backend:r,bias:o,activation:u,preluActivationWeights:n,leakyreluAlpha:a}),Z=H({inputs:{x:Q},backend:r,attrs:{shape:e.outShape}});W.push(Q);for(const ie of W)r.disposeData(ie.dataId);return Z}function rn({x:i,filter:t,convInfo:e,backend:r,bias:o=null,preluActivationWeights:n=null,leakyreluAlpha:a=0,activation:u=null}){const c=o!=null,h=n!=null,p=e.dataFormat==="channelsLast",d=p&&e.filterHeight===e.inHeight&&e.filterWidth===e.inWidth&&e.padInfo.type==="VALID",m=fe().getBool("WEBGPU_USE_NAIVE_CONV2D_DEBUG");if(!m&&(d||e.filterHeight===1&&e.filterWidth===1&&e.dilationHeight===1&&e.dilationWidth===1&&e.strideHeight===1&&e.strideWidth===1&&(e.padInfo.type==="SAME"||e.padInfo.type==="VALID")))return Bm({x:i,filter:t,convInfo:e,backend:r,bias:o,activation:u,preluActivationWeights:n,leakyreluAlpha:a});const x=fe().getNumber("WEBGPU_THRESHOLD_TO_INCREASE_WORKGROUPS_FOR_MATMUL"),y=x>-1?x:r.thresholdToIncreaseWorkgroups,w=e.batchSize*Math.ceil(e.outHeight*e.outWidth/32)*Math.ceil(e.outChannels/32);if(fe().getBool("WEBGPU_CONV_SEPARATE_IM2COL_SHADER")||w<=y)return Wm({x:i,filter:t,convInfo:e,backend:r,bias:o,preluActivationWeights:n,leakyreluAlpha:a,activation:u});let b;const I=[e.padInfo.top,e.padInfo.left],R=[{type:"int32",data:[e.filterHeight,e.filterWidth]},{type:"int32",data:[...I]},{type:"int32",data:[e.strideHeight,e.strideWidth]},{type:"int32",data:[e.dilationHeight,e.dilationWidth]}];if(m)b=new Lm(e,c,u,h);else{const D=p?e.outHeight*e.outWidth:e.outChannels,T=p?e.outChannels:e.outHeight*e.outWidth,E=e.filterHeight*e.filterWidth*e.inChannels;R.push({type:"int32",data:[D]},{type:"int32",data:[T]},{type:"int32",data:[E]});const F=r.adapterInfo.isIntel();b=new Mm(e,D,T,E,c,u,h,F)}const P=[],A=[i,t];c&&(!p&&o.shape.length===1&&(o=H({inputs:{x:o},backend:r,attrs:{shape:[o.shape[0],1,1]}}),P.push(o)),A.push(o)),h&&(!p&&n.shape.length===1&&(n=H({inputs:{x:n},backend:r,attrs:{shape:[n.shape[0],1,1]}}),P.push(n)),A.push(n)),u==="leakyrelu"&&(R.push({type:"float32",data:[a]}),b.uniforms+=" alpha : f32,");const N=r.runWebGPUProgram(b,A,i.dtype,R);for(const D of P)r.disposeData(D.dataId);return N}/**
 * @license
 * Copyright 2021 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function Um(i){const{inputs:t,attrs:e,backend:r}=i,{x:o,filter:n}=t,{strides:a,pad:u,dataFormat:c,dilations:h,dimRoundingMode:p}=e,d=ci(c),m=rt(o.shape,n.shape,a,h,u,p,!1,d);return rn({x:o,filter:n,convInfo:m,backend:r})}const Vm={kernelName:Uu,backendName:"webgpu",kernelFunc:Um};/**
 * @license
 * Copyright 2021 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 */class Gm{constructor(t){this.variableNames=["dy","W"],this.uniforms="filterDims : vec2<i32>, pads : vec2<i32>, strides : vec2<i32>, outBackprop : vec4<i32>,",this.workgroupSize=[64,1,1],this.size=!1,this.isVec4=!1,this.workPerThread=1,this.outputShape=t.inShape,this.isChannelsLast=t.dataFormat==="channelsLast",this.isVec4=this.isChannelsLast&&t.outChannels%4===0&&t.inChannels%4===0,this.isVec4?(this.workPerThread=2,this.outputComponent=4,this.workgroupSize=[4,4,4],this.dispatchLayout={x:[3],y:[2],z:[0,1]},this.dispatch=L(this.dispatchLayout,this.outputShape,this.workgroupSize,[4,this.workPerThread,1])):(this.size=!0,this.workPerThread=1,this.workgroupSize=[64,1,1],this.dispatchLayout=U(this.outputShape),this.dispatch=L(this.dispatchLayout,this.outputShape,this.workgroupSize)),this.shaderKey=`conv2DDerInput_${this.isChannelsLast}_${this.isVec4}_${this.workPerThread}`}getUserCode(){const t=this.isChannelsLast?1:2,e=this.isChannelsLast?2:3,r=this.isChannelsLast?3:1,o=`
  ...
  `}}class jm{constructor(t){this.variableNames=["x","dy"],this.uniforms=`pads : vec3<i32>, strides : vec3<i32>, batchSize : i32, outDepth : i32,
  ...
  `}}class Xm{constructor(t){this.variableNames=["dy","W"],this.uniforms=`filterDims : vec3<i32>, pads : vec3<i32>, strides : vec3<i32>,
 ...
 * limitations under the License.
 * =============================================================================
 */function Zm(i){const{inputs:t,backend:e,attrs:r}=i,{dy:o,filter:n}=t,{inputShape:a,strides:u,pad:c,dataFormat:h,dimRoundingMode:p}=r,d=ci(h),m=rt(a,n.shape,u,1,c,p,!1,d),x=[{type:"int32",data:[m.filterHeight,m.filterWidth]},{type:"int32",data:[m.filterHeight-1-m.padInfo.top,m.filterWidth-1-m.padInfo.left]},{type:"int32",data:[m.strideHeight,m.strideWidth]},{type:"int32",data:[m.batchSize,m.outHeight,m.outWidth,m.outChannels]}];let y;if(fe().getBool("WEBGPU_USE_NAIVE_CONV2D_TRANSPOSE")||m.dataFormat!=="channelsLast")y=new Gm(m);else{y=new Qm(m);const w=m.inHeight*m.inWidth,b=m.inChannels,I=m.filterHeight*m.filterWidth*m.outChannels;x.push({type:"uint32",data:[w]},{type:"uint32",data:[b]},{type:"uint32",data:[I]})}return e.runWebGPUProgram(y,[o,n],"float32",x)}const Jm={kernelName:Gu,backendName:"webgpu",kernelFunc:Zm};/**
 * @license
 * Copyright 2023 Google LLC.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */class eg{constructor(t){this.variableNames=["x","W"],this.uniforms="filterDims: vec3<i32>, pads: vec3<i32>, strides: vec3<i32>, dilations: vec3<i32>,",this.workgroupSize=[64,1,1],this.size=!0,this.outputShape=t.outShape,this.dispatchLayout=U(this.outputShape),this.dispatch=L(this.dispatchLayout,this.outputShape,this.workgroupSize),this.shaderKey="conv3dnaive"}getUserCode(){return`
    ${M("index")} {
      if (index < uniforms.size) {
        let coords = getOutputCoords();
        let batch = coords.x;
 ...
 * limitations under the License.
 * =============================================================================
 */function tg(i){const{inputs:t,backend:e,attrs:r}=i,{x:o,filter:n}=t,{strides:a,pad:u,dilations:c}=r,h=Ar(o.shape,n.shape,a,c,u),p=[h.padInfo.front,h.padInfo.top,h.padInfo.left],d=[{type:"int32",data:[h.filterDepth,h.filterHeight,h.filterWidth]},{type:"int32",data:[...p]},{type:"int32",data:[h.strideDepth,h.strideHeight,h.strideWidth]},{type:"int32",data:[h.dilationDepth,h.dilationHeight,h.dilationWidth]}],m=new eg(h),x=Jt(o.dtype,n.dtype);return e.runWebGPUProgram(m,[o,n],x,d)}const ig={kernelName:Hu,backendName:"webgpu",kernelFunc:tg};/**
 * @license
 * Copyright 2023 Google LLC.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function sg(i){const{inputs:t,backend:e,attrs:r}=i,{dy:o,filter:n}=t,{strides:a,pad:u,inputShape:c}=r,h=Ar(c,n.shape,a,1,u),p=new Xm(h),d=[{type:"int32",data:[h.filterDepth,h.filterHeight,h.filterWidth]},{type:"int32",data:[h.filterDepth-1-h.padInfo.front,h.filterHeight-1-h.padInfo.top,h.filterWidth-1-h.padInfo.left]},{type:"int32",data:[h.strideDepth,h.strideHeight,h.strideWidth]},{type:"int32",data:[h.outDepth]},{type:"int32",data:[h.outHeight]},{type:"int32",data:[h.outWidth]},{type:"int32",data:[h.outChannels]}];return e.runWebGPUProgram(p,[o,n],o.dtype,d)}const ng={kernelName:Xu,backendName:"webgpu",kernelFunc:sg};/**
 * @license
 * Copyright 2021 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */const ag=se({opType:z.COS}),ug={kernelName:Ku,backendName:"webgpu",kernelFunc:ag};/**
 * @license
 * Copyright 2021 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */const lg=se({opType:z.COSH}),cg={kernelName:Yu,backendName:"webgpu",kernelFunc:lg};/**
 * @license
 * Copyright 2019 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */const dg=i=>{const{inputs:t,backend:e,attrs:r}=i,{image:o,boxes:n,boxInd:a}=t,{cropSize:u,method:c,extrapolationValue:h}=r,p=new hg(o.shape[3],n.shape,u,c),d=[{type:"float32",data:[h]}];return e.runWebGPUProgram(p,[o,n,a],"float32",d)},pg={kernelName:qu,backendName:"webgpu",kernelFunc:dg};/**
 * @license
 * Copyright 2022 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function fg(i){const{inputs:t,backend:e,attrs:r}=i,{x:o}=t,{axis:n,exclusive:a,reverse:u}=r;return on(si.Prod,o,e,n,a,u)}const mg={kernelName:Qu,backendName:"webgpu",kernelFunc:fg};/**
 * @license
 * Copyright 2022 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function gg(i){const{inputs:t,backend:e,attrs:r}=i,{x:o}=t,{axis:n,exclusive:a,reverse:u}=r;return on(si.Sum,o,e,n,a,u)}const xg={kernelName:Zu,backendName:"webgpu",kernelFunc:gg};/**
 * @license
 * Copyright 2022 Google LLC.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */class vg{constructor(t,e){this.variableNames=["x"],this.workgroupSize=[64,1,1],this.size=!0,this.uniforms="blockSize : i32,",this.outputShape=t,this.dispatchLayout=U(this.outputShape),this.dispatch=L(this.dispatchLayout,this.outputShape,this.workgroupSize),this.shaderKey=`depthToSpace_${e}`,this.dataFormat=e}getUserCode(){return`
      ${M("index")} {
        if (index < uniforms.size) {
          let coords = getCoordsFromIndex(index);
          let b = coords[0];
 ...
 * limitations under the License.
 * =============================================================================
 */function Cg(i){const{inputs:t,backend:e,attrs:r}=i,{x:o}=t,{blockSize:n,dataFormat:a}=r,u=o.shape[0],c=a==="NHWC"?o.shape[1]:o.shape[2],h=a==="NHWC"?o.shape[2]:o.shape[3],p=a==="NHWC"?o.shape[3]:o.shape[1],d=c*n,m=h*n,x=p/(n*n),y=a==="NHWC"?[u,d,m,x]:[u,x,d,m],w=[{type:"int32",data:[n]}],b=new vg(y,a);return e.runWebGPUProgram(b,[o],o.dtype,w)}const bg={kernelName:el,backendName:"webgpu",kernelFunc:Cg};/**
 * @license
 * Copyright 2022 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */class Rg{constructor(t){this.variableNames=["x","dy"],this.uniforms=`strides : vec2<i32>, pads : vec2<i32>, filterDims : vec2<i32>, outHeight : i32,
    ...
    `}}class Pg{constructor(t){this.variableNames=["dy","W"],this.uniforms=`strides : vec2<i32>, pads : vec2<i32>, filterDims : vec2<i32>,
 ...
 * limitations under the License.
 * =============================================================================
 */class Tg{constructor(t){this.variableNames=["x"],this.workgroupSize=[64,1,1],this.size=!0,this.outputShape=[t,t],this.dispatchLayout=U(this.outputShape),this.dispatch=L(this.dispatchLayout,this.outputShape,this.workgroupSize),this.shaderKey="diag"}getUserCode(){return`
      ${M("index")} {
        if (index < uniforms.size) {
          let coords = getOutputCoords();
 ...
 * limitations under the License.
 * =============================================================================
 */function Fg(i){const{inputs:t,backend:e}=i,{x:r}=t,o=[...r.shape,...r.shape],n=J(r.shape),a=H({inputs:{x:r},backend:e,attrs:{shape:[n]}}),u=new Tg(n),c=e.runWebGPUProgram(u,[a],a.dtype),h=H({inputs:{x:c},backend:e,attrs:{shape:o}});return e.disposeData(a.dataId),e.disposeData(c.dataId),h}const Eg={kernelName:ol,backendName:"webgpu",kernelFunc:Fg};/**
 * @license
 * Copyright 2022 Google LLC.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function Bg(i){const{inputs:t,backend:e,attrs:r}=i,{x:o,filter:n,dy:a}=t,{strides:u,pad:c,dilations:h}=r,p=$r(o.shape,n.shape,u,c,"NHWC",h),d=n.dtype,m=new Og(p,n.shape,d),x=[{type:"int32",data:[p.filterHeight,p.filterWidth]},{type:"int32",data:[p.padInfo.top,p.padInfo.left]},{type:"int32",data:[p.strideHeight,p.strideWidth]},{type:"int32",data:[p.dilationHeight,p.dilationWidth]},{type:"int32",data:[J(p.outShape)]}],y=$e({backend:e,attrs:{shape:n.shape,value:0,dtype:d}});return e.runWebGPUProgram(m,[o,n,a],d,x,y)}const Wg={kernelName:nl,backendName:"webgpu",kernelFunc:Bg};/**
 * @license
 * Copyright 2023 Google LLC.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function Ug(i){const{inputs:t,backend:e,attrs:r}=i,{x:o,filter:n,dy:a}=t,{strides:u,pad:c,dilations:h}=r,p=$r(o.shape,n.shape,u,c,"NHWC",h),d=o.dtype,m=new Lg(p,d),x=[{type:"int32",data:[p.filterHeight,p.filterWidth]},{type:"int32",data:[p.padInfo.top,p.padInfo.left]},{type:"int32",data:[p.strideHeight,p.strideWidth]},{type:"int32",data:[p.dilationHeight,p.dilationWidth]},{type:"int32",data:[J(p.outShape)]}],y=$e({backend:e,attrs:{shape:p.inShape,value:0,dtype:d}});return e.runWebGPUProgram(m,[o,n,a],d,x,y)}const Vg={kernelName:al,backendName:"webgpu",kernelFunc:Ug};/**
 * @license
 * Copyright 2023 Google LLC.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */const an=ye({opType:K.MUL,cpuKernelImpl:qp,supportsComplex:!0}),Xg={kernelName:ll,backendName:"webgpu",kernelFunc:an};/**
 * @license
 * Copyright 2021 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function un(i){const{inputs:t,backend:e,attrs:r}=i,{x:o}=t,{axis:n,keepDims:a}=r;return xt(o,n,a,"sum",e)}const Kg={kernelName:cl,backendName:"webgpu",kernelFunc:un};/**
 * @license
 * Copyright 2021 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */const Qg=se({opType:z.ELU}),Zg={kernelName:xl,backendName:"webgpu",kernelFunc:Qg};/**
 * @license
 * Copyright 2023 Google LLC.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */const Jg=i=>{const{inputs:t,backend:e}=i,{dy:r,y:o}=t,n=new Ri(K.ELU_DER,r.shape,o.shape);return e.runWebGPUProgram(n,[r,o],r.dtype)},ex={kernelName:yl,backendName:"webgpu",kernelFunc:Jg};/**
 * @license
 * Copyright 2021 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */const tx=ye({opType:K.EQUAL,dtype:"bool",cpuKernelImpl:_p}),ix={kernelName:wl,backendName:"webgpu",kernelFunc:tx};/**
 * @license
 * Copyright 2022 Google LLC.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */const rx=se({opType:z.ERF}),ox={kernelName:vl,backendName:"webgpu",kernelFunc:rx};/**
 * @license
 * Copyright 2021 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */const sx=se({opType:z.EXP,cpuKernelImpl:zp,dtype:"float32"}),nx={kernelName:Cl,backendName:"webgpu",kernelFunc:sx};/**
 * @license
 * Copyright 2021 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the License);
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function vr(i){const{inputs:t,attrs:e,backend:r}=i,{dim:o}=e,{input:n}=t,a=n.shape.length,u=n.shape.slice();let c=o;return o<0&&(ne(-(a+1)<=o,()=>`Axis must be in the interval [${-(a+1)}, ${a}]`),c=a+o+1),u.splice(c,0,1),H({inputs:{x:n},backend:r,attrs:{shape:u}})}const ax={kernelName:bl,backendName:"webgpu",kernelFunc:vr};/**
 * @license
 * Copyright 2021 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */const ux=se({opType:z.EXPM1,cpuKernelImpl:Mp}),lx={kernelName:Sl,backendName:"webgpu",kernelFunc:ux};/**
 * @license
 * Copyright 2022 Google LLC.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function cx(i){const{inputs:t,backend:e}=i,{input:r}=t;return ln(r,!1,e)}const hx={kernelName:kl,backendName:"webgpu",kernelFunc:cx};/**
 * @license
 * Copyright 2021 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */class dx{constructor(t){this.outputShape=[],this.variableNames=["x"],this.workgroupSize=[64,1,1],this.size=!0,this.outputShape=t,this.dispatchLayout=U(this.outputShape),this.dispatch=L(this.dispatchLayout,this.outputShape,this.workgroupSize),this.shaderKey="flipLeftRight"}getUserCode(){return`
      ${M("index")} {
        if (index < uniforms.size) {
          let coords = getCoordsFromIndex(index);
 ...
 * limitations under the License.
 * =============================================================================
 */const px={kernelName:Il,backendName:"webgpu",kernelFunc:({inputs:i,backend:t})=>{const{image:e}=i,r=t,o=new dx(e.shape);return r.runWebGPUProgram(o,[e],e.dtype)}};/**
 * @license
 * Copyright 2021 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */const fx=se({opType:z.FLOOR,cpuKernelImpl:Lp}),mx={kernelName:Rl,backendName:"webgpu",kernelFunc:fx};/**
 * @license
 * Copyright 2021 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */const gx=ye({opType:K.FLOOR_DIV,cpuKernelImpl:Op,dtype:"int32"}),xx={kernelName:Pl,backendName:"webgpu",kernelFunc:gx};/**
 * @license
 * Copyright 2022 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */const bx={kernelName:$l,backendName:"webgpu",kernelFunc:({inputs:i,attrs:t,backend:e})=>{const{x:r,scale:o,offset:n,mean:a,variance:u}=i,{varianceEpsilon:c}=t,h=e,p=[r,a,u];let d=null;n!=null&&(d=n.shape,p.push(n));let m=null;o!=null&&(m=o.shape,p.push(o));const x=new Cx(r.shape,a.shape,u.shape,d,m),y=[{type:"float32",data:[c]}];return h.runWebGPUProgram(x,p,r.dtype,y)}};/**
 * @license
 * Copyright 2021 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function Sx(i){const{inputs:t,backend:e,attrs:r}=i,{x:o,filter:n,bias:a,preluActivationWeights:u}=t,{strides:c,pad:h,dataFormat:p,dilations:d,dimRoundingMode:m,activation:x,leakyreluAlpha:y}=r,w=ci(p),b=rt(o.shape,n.shape,c,d,h,m,!1,w);return rn({x:o,filter:n,convInfo:b,backend:e,bias:a,preluActivationWeights:u,leakyreluAlpha:y,activation:x})}const kx={kernelName:Nl,backendName:"webgpu",kernelFunc:Sx};/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function Ax(i){const{inputs:t,backend:e}=i,{params:r,indices:o}=t,n=o.shape,a=n[n.length-1],u=J(r.shape),[c,h,p,d]=Fl(r,o),m=H({inputs:{x:o},backend:e,attrs:{shape:[h,a]}}),x=H({inputs:{x:r},backend:e,attrs:{shape:[J(r.shape)/p,p]}});if(e.shouldExecuteOnCPU([r,o])||r.dtype==="string"){const R=e.readSync(o.dataId),P=e.bufferSync(r),A=Bp(R,P,r.dtype,h,a,p,d,r.shape,u);return e.makeTensorInfo(c,r.dtype,A.values)}const y=new Px(a,[h,p]),w=[{type:"int32",data:[a]},{type:"int32",data:d}],b=e.runWebGPUProgram(y,[x,m],x.dtype,w),I=H({inputs:{x:b},backend:e,attrs:{shape:c}});return e.disposeData(m.dataId),e.disposeData(x.dataId),e.disposeData(b.dataId),I}const $x={kernelName:Tl,backendName:"webgpu",kernelFunc:Ax};/**
 * @license
 * Copyright 2021 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 */class Nx{constructor(t,e){this.variableNames=["A","indices"],this.workgroupSize=[64,1,1],this.size=!0,this.outputShape=t.slice(),this.aShape=t,this.outputShape=e,this.dispatchLayout=U(this.outputShape),this.dispatch=L(this.dispatchLayout,this.outputShape,this.workgroupSize),this.shaderKey="gather"}getUserCode(){const t=Dx(this.aShape);return`
    ...
    `}}function Dx(i){const t=["resRC.x","resRC.y","resRC.z","resRC.w"],e=[];for(let r=0;r<i.length;r++)r===2?e.push("indexZ"):e.push(`${t[r]}`);return e.join()}/**
 * @license
 * Copyright 2021 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */const Fx=ye({opType:K.GREATER,cpuKernelImpl:Vp,dtype:"bool"}),Ex={kernelName:zl,backendName:"webgpu",kernelFunc:Fx};/**
 * @license
 * Copyright 2021 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */const _x=ye({opType:K.GREATER_EQUAL,dtype:"bool",cpuKernelImpl:Up}),zx={kernelName:Ml,backendName:"webgpu",kernelFunc:_x};/**
 * @license
 * Copyright 2022 Google LLC.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function Mx(i){const{inputs:t,backend:e}=i,{input:r}=t;return ln(r,!0,e)}const Lx={kernelName:Ll,backendName:"webgpu",kernelFunc:Mx};/**
 * @license
 * Copyright 2022 Google LLC.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */const Ox=se({opType:z.IS_FINITE,dtype:"bool"}),Bx={kernelName:Ol,backendName:"webgpu",kernelFunc:Ox};/**
 * @license
 * Copyright 2022 Google LLC.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */const Wx=se({opType:z.IS_INF,dtype:"bool"}),Ux={kernelName:Bl,backendName:"webgpu",kernelFunc:Wx};/**
 * @license
 * Copyright 2022 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */const Vx=se({opType:z.IS_NAN,dtype:"bool"}),Gx={kernelName:Wl,backendName:"webgpu",kernelFunc:Vx};/**
 * @license
 * Copyright 2021 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function Hx(i){const{inputs:t,backend:e,attrs:r}=i,{x:o}=t,{alpha:n}=r,a=[{type:"float32",data:[n]}],u=new Et(o.shape,z.LEAKYRELU,"alpha : f32,");return e.runWebGPUProgram(u,[o],"float32",a)}const jx={kernelName:Ul,backendName:"webgpu",kernelFunc:Hx};/**
 * @license
 * Copyright 2021 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */const Xx=ye({opType:K.LESS,dtype:"bool",cpuKernelImpl:Hp}),Kx={kernelName:Vl,backendName:"webgpu",kernelFunc:Xx};/**
 * @license
 * Copyright 2021 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */const Yx=ye({opType:K.LESS_EQUAL,dtype:"bool",cpuKernelImpl:Gp}),qx={kernelName:Gl,backendName:"webgpu",kernelFunc:Yx};/**
 * @license
 * Copyright 2022 Google LLC.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */class Qx{constructor(t){this.variableNames=[],this.outputShape=[],this.uniforms="start : f32, step : f32,",this.workgroupSize=[64,1,1],this.size=!0,this.outputShape=[t],this.dispatchLayout=U(this.outputShape),this.dispatch=L(this.dispatchLayout,this.outputShape,this.workgroupSize),this.shaderKey="linSpace"}getUserCode(){return`
      ${M("index")} {
        if (index < uniforms.size) {
 ...
 * limitations under the License.
 * =============================================================================
 */function Zx(i){const{backend:t,attrs:e}=i,{start:r,stop:o,num:n}=e,a=(o-r)/(n-1),u=new Qx(n),c=[{type:"float32",data:[r]},{type:"float32",data:[a]}];return t.runWebGPUProgram(u,[],"float32",c)}const Jx={kernelName:Hl,backendName:"webgpu",kernelFunc:Zx};/**
 * @license
 * Copyright 2021 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */const ey=se({opType:z.LOG,cpuKernelImpl:jp}),ty={kernelName:jl,backendName:"webgpu",kernelFunc:ey};/**
 * @license
 * Copyright 2022 Google LLC.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */const iy=se({opType:z.LOG1P}),ry={kernelName:Xl,backendName:"webgpu",kernelFunc:iy};/**
 * @license
 * Copyright 2021 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */const oy=ye({opType:K.LOGICAL_AND,dtype:"bool"}),sy={kernelName:Kl,backendName:"webgpu",kernelFunc:oy};/**
 * @license
 * Copyright 2021 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */const ny=se({opType:z.LOGICAL_NOT}),ay={kernelName:Yl,backendName:"webgpu",kernelFunc:ny};/**
 * @license
 * Copyright 2022 Google LLC.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */const uy=ye({opType:K.LOGICAL_OR}),ly={kernelName:ql,backendName:"webgpu",kernelFunc:uy};/**
 * @license
 * Copyright 2022 Google LLC.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
...
`;class cy{constructor(t){this.outputShape=[],this.variableNames=["x"],this.uniforms="radius : i32, bias : f32, alpha : f32, beta : f32,",this.workgroupSize=[64,1,1],this.size=!0,this.outputShape=t,this.dispatchLayout=U(this.outputShape),this.dispatch=L(this.dispatchLayout,this.outputShape,this.workgroupSize),this.shaderKey="lrn"}getUserCode(){return`
    ${M("index")} {
      if (index < uniforms.size) {
        let coords = getOutputCoords();
        let b = coords[0];
 ...
 * limitations under the License.
 * =============================================================================
 */function dy(i){const{inputs:t,backend:e,attrs:r}=i,{x:o}=t,{depthRadius:n,bias:a,alpha:u,beta:c}=r;let h;n>16?h=new cy(o.shape):h=new hy(o.shape,n);const p=[{type:"int32",data:[n]},{type:"float32",data:[a]},{type:"float32",data:[u]},{type:"float32",data:[c]}];return e.runWebGPUProgram(h,[o],o.dtype,p)}const py={kernelName:Ql,backendName:"webgpu",kernelFunc:dy};/**
 * @license
 * Copyright 2023 Google LLC.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function my(i){const{inputs:t,backend:e,attrs:r}=i,{x:o,y:n,dy:a}=t,{depthRadius:u,bias:c,alpha:h,beta:p}=r,d=new fy(o.shape),m=[{type:"int32",data:[u]},{type:"float32",data:[c]},{type:"float32",data:[h]},{type:"float32",data:[p]}];return e.runWebGPUProgram(d,[o,n,a],o.dtype,m)}const gy={kernelName:Zl,backendName:"webgpu",kernelFunc:my};/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */const xy=ye({opType:K.MAX,cpuKernelImpl:Kp}),yy={kernelName:Jl,backendName:"webgpu",kernelFunc:xy};/**
 * @license
 * Copyright 2021 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function wy(i){const{inputs:t,backend:e,attrs:r}=i,{x:o}=t,{filterSize:n,strides:a,pad:u,dimRoundingMode:c}=r,p=li(o.shape,n,a,1,u,c);return Zs(o,p,"max",e)}const vy={kernelName:ec,backendName:"webgpu",kernelFunc:wy};/**
 * @license
 * Copyright 2023 Google LLC.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function Cy(i){const{inputs:t,backend:e,attrs:r}=i,{x:o}=t,{filterSize:n,strides:a,pad:u,dataFormat:c,dimRoundingMode:h}=r,p=[1,1,1],d=Ni(o.shape,n,a,p,u,h,c),m=new _r(d,"max"),x=[{type:"int32",data:[d.strideDepth,d.strideHeight,d.strideWidth]},{type:"int32",data:[d.padInfo.front,d.padInfo.top,d.padInfo.left]},{type:"int32",data:[d.inDepth,d.inHeight,d.inWidth]},{type:"int32",data:[d.effectiveFilterDepth,d.effectiveFilterHeight,d.effectiveFilterWidth]}];return e.runWebGPUProgram(m,[o],o.dtype,x)}const by={kernelName:tc,backendName:"webgpu",kernelFunc:Cy};/**
 * @license
 * Copyright 2023 Google LLC.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */class Sy{constructor(t){this.variableNames=["dy","maxPos"],this.uniforms=`strides : vec2<i32>, pads : vec2<i32>, dilations : vec2<i32>, filterDims : vec2<i32>,
    ...
    `}}class ky{constructor(t){this.variableNames=["dy","maxPos"],this.uniforms=`strides : vec3<i32>, pads : vec3<i32>, filterDims : vec3<i32>,
 ...
 * limitations under the License.
 * =============================================================================
 */function $y(i){const{inputs:t,backend:e,attrs:r}=i,{filterSize:o,strides:n,pad:a,includeBatchInIndex:u}=r,{x:c}=t;ne(c.shape.length===4,()=>`Error in maxPool: input must be rank 4 but got rank ${c.shape.length}.`);const h=[1,1];ne(Bs(n,h),()=>`Error in maxPool: Either strides or dilations must be 1. Got strides ${n} and dilations '${h}'`);const p=li(c.shape,o,n,h,a),d=[{type:"int32",data:[p.strideHeight,p.strideWidth]},{type:"int32",data:[p.padInfo.top,p.padInfo.left]},{type:"int32",data:[p.dilationHeight,p.dilationWidth]},{type:"int32",data:[p.inHeight,p.inWidth]},{type:"int32",data:[p.effectiveFilterHeight,p.effectiveFilterWidth]}];let m=new oi(p,"max",!1);const x=e.runWebGPUProgram(m,[c],c.dtype,d);m=new oi(p,"max",!0,!0,u);const y=e.runWebGPUProgram(m,[c],"int32",d);return[x,y]}const Ny={kernelName:oc,backendName:"webgpu",kernelFunc:$y};/**
 * @license
 * Copyright 2021 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function Dy(i){const{inputs:t,backend:e,attrs:r}=i,{x:o}=t,{axis:n,keepDims:a}=r;return xt(o,n,a,"min",e)}const Ty={kernelName:sc,backendName:"webgpu",kernelFunc:Dy};/**
 * @license
 * Copyright 2021 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */const Fy=ye({opType:K.MIN,cpuKernelImpl:Yp}),Ey={kernelName:nc,backendName:"webgpu",kernelFunc:Fy};/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */const zy={kernelName:ac,backendName:"webgpu",kernelFunc:({inputs:i,attrs:t,backend:e})=>{const{x:r}=i,{paddings:o,mode:n}=t,a=e,u=o.map(p=>({type:"int32",data:[p[0],p[1]]})),c=new _y(r.shape,o,n);return a.runWebGPUProgram(c,[r],r.dtype,u)}};/**
 * @license
 * Copyright 2022 Google LLC.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */const My=ye({opType:K.MOD}),Ly={kernelName:uc,backendName:"webgpu",kernelFunc:My};/**
 * @license
 * Copyright 2023 Google LLC.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */class By{constructor(t){this.variableNames=["logits"],this.outputShape=t,this.dispatchLayout=U(this.outputShape),this.dispatch=[this.outputShape[0],1,1],this.outputShape[1]>=4096?this.workgroupSize=[256,1,1]:this.workgroupSize=[64,1,1],this.shaderKey="softmax"}getUserCode(){return`
 ...
 * limitations under the License.
 * =============================================================================
 */function Uy(i){const{inputs:t,backend:e,attrs:r}=i,{logits:o}=t,{numSamples:n,seed:a,normalized:u}=r,c=u?o:dn({inputs:{logits:o},backend:e,attrs:{dim:o.shape.length-1}}),h=c.shape[0],p=c.shape[1],d=new Oy(h,n),m=[{type:"float32",data:[a]},{type:"int32",data:[p]}],x=e.runWebGPUProgram(d,[c],"int32",m);return u||e.disposeData(c.dataId),x}const Vy={kernelName:cc,backendName:"webgpu",kernelFunc:Uy};/**
 * @license
 * Copyright 2021 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function Gy(i){const{inputs:t,backend:e}=i,{x:r}=t;if(e.shouldExecuteOnCPU([r])){const n=e.tensorMap.get(r.dataId),[a,u]=Qp(n.values,r.shape,r.dtype);return e.makeTensorInfo(u,r.dtype,a)}const o=new Et(r.shape,z.NEG);return e.runWebGPUProgram(o,[r],r.dtype)}const Hy={kernelName:hc,backendName:"webgpu",kernelFunc:Gy};/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function Qy(i){const{inputs:t,backend:e,attrs:r}=i,{indices:o}=t,{dtype:n,depth:a,onValue:u,offValue:c}=r,h=J(o.shape),p=new qy(h,a),d=H({inputs:{x:o},backend:e,attrs:{shape:[h]}}),m=[{type:"float32",data:[u]},{type:"float32",data:[c]}],x=e.runWebGPUProgram(p,[d],n,m);e.disposeData(d.dataId);const y=[...o.shape,a],w=H({inputs:{x},backend:e,attrs:{shape:y}});return e.disposeData(x.dataId),w}const Zy={kernelName:gc,backendName:"webgpu",kernelFunc:Qy};/**
 * @license
 * Copyright 2021 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function t2(i){const{inputs:t,backend:e,attrs:r}=i,{axis:o}=r;if(t.length===1)return vr({inputs:{input:t[0]},backend:e,attrs:{dim:o}});const n=t[0].shape,a=t[0].dtype;t.forEach(p=>{vc(n,p.shape,"All tensors passed to stack must have matching shapes"),ne(a===p.dtype,()=>"All tensors passed to stack must have matching dtypes")});const u=[],c=t.map(p=>{const d=vr({inputs:{input:p},backend:e,attrs:{dim:o}});return u.push(d),d}),h=tn({inputs:c,backend:e,attrs:{axis:o}});return u.forEach(p=>e.disposeData(p.dataId)),h}const i2={kernelName:wc,backendName:"webgpu",kernelFunc:t2};/**
 * @license
 * Copyright 2019 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */const o2=i=>{const{inputs:t,backend:e,attrs:r}=i,{x:o}=t,{paddings:n,constantValue:a}=r;if(n.every(h=>Dt(h,[0,0])))return Ee({inputs:{x:o},backend:e});if(J(o.shape)===0){const h=n.map((p,d)=>p[0]+o.shape[d]+p[1]);return $e({backend:e,attrs:{shape:h,value:a,dtype:o.dtype}})}const u=[{type:"float32",data:[a]}];n.map(h=>u.push({type:"int32",data:[h[0],h[1]]}));const c=new r2(o.shape,n);return e.runWebGPUProgram(c,[o],o.dtype,u)},s2={kernelName:Cc,backendName:"webgpu",kernelFunc:o2};/**
 * @license
 * Copyright 2021 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */const n2=ye({opType:K.POW}),a2={kernelName:bc,backendName:"webgpu",kernelFunc:n2};/**
 * @license
 * Copyright 2021 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function u2(i){const{inputs:t,backend:e}=i,{x:r,alpha:o}=t,n=new Ri(K.PRELU,r.shape,o.shape);return e.runWebGPUProgram(n,[r,o],"float32")}const l2={kernelName:Sc,backendName:"webgpu",kernelFunc:u2};/**
 * @license
 * Copyright 2021 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function c2(i){const{inputs:t,backend:e,attrs:r}=i,{x:o}=t,{axis:n,keepDims:a}=r;return xt(o,n,a,"prod",e)}const h2={kernelName:kc,backendName:"webgpu",kernelFunc:c2};/**
 * @license
 * Copyright 2021 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */const d2=i=>{const{backend:t,attrs:e}=i,{start:r,stop:o,step:n,dtype:a}=e,u=ef(r,o,n,a);return t.makeTensorInfo([u.length],a,u)},p2={kernelName:Ic,backendName:"webgpu",kernelFunc:d2};/**
 * @license
 * Copyright 2021 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */const f2=ye({opType:K.DIV}),m2={kernelName:Rc,backendName:"webgpu",kernelFunc:f2};/**
 * @license
 * Copyright 2022 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */const g2=se({opType:z.RECIPROCAL}),x2={kernelName:Pc,backendName:"webgpu",kernelFunc:g2};/**
 * @license
 * Copyright 2021 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */const y2=se({opType:z.RELU}),w2={kernelName:Ac,backendName:"webgpu",kernelFunc:y2};/**
 * @license
 * Copyright 2021 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */const v2=se({opType:z.RELU6}),C2={kernelName:$c,backendName:"webgpu",kernelFunc:v2};/**
 * @license
 * Copyright 2019 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function S2(i){const{inputs:t,backend:e,attrs:r}=i,{images:o}=t,{alignCorners:n,size:a,halfPixelCenters:u}=r,[c,h]=a,p=n&&c>1?1:0,d=n&&h>1?1:0,x=[{type:"float32",data:[p,d]},{type:"float32",data:[u?.5:0]}],y=new b2(o.shape,c,h);return e.runWebGPUProgram(y,[o],"float32",x)}const k2={kernelName:Nc,backendName:"webgpu",kernelFunc:S2};/**
 * @license
 * Copyright 2023 Google LLC.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */class I2{constructor(t,e){this.variableNames=["dy"],this.uniforms=`effectiveXSize : vec2<i32>, effectiveYSize : vec2<i32>, heightScale : f32, widthScale : f32,
 ...
 * limitations under the License.
 * =============================================================================
 */function R2(i){const{inputs:t,backend:e,attrs:r}=i,{images:o,dy:n}=t,{alignCorners:a}=r,[,u,c]=o.shape,[,h,p]=n.shape,d=[a&&h>1?u-1:u,a&&p>1?c-1:c],m=[a&&h>1?h-1:h,a&&p>1?p-1:p],x=d[0]/m[0],y=d[1]/m[1],w=1/x,b=1/y,I=Math.ceil(w)*2+2,R=Math.ceil(b)*2+2,P=new I2(o.shape,a),A=[{type:"int32",data:d},{type:"int32",data:m},{type:"float32",data:[x]},{type:"float32",data:[y]},{type:"float32",data:[w]},{type:"float32",data:[b]},{type:"int32",data:[I]},{type:"int32",data:[R]}];return e.runWebGPUProgram(P,[n],n.dtype,A)}const P2={kernelName:Dc,backendName:"webgpu",kernelFunc:R2};/**
 * @license
 * Copyright 2021 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function $2(i){const{inputs:t,backend:e,attrs:r}=i,{images:o}=t,{alignCorners:n,halfPixelCenters:a,size:u}=r,[c,h]=u,p=n&&c>1?1:0,d=n&&h>1?1:0,x=[{type:"float32",data:[p,d]},{type:"float32",data:[n?.5:0]}],y=new A2(o.shape,c,h,a);return e.runWebGPUProgram(y,[o],o.dtype,x)}const N2={kernelName:Tc,backendName:"webgpu",kernelFunc:$2};/**
 * @license
 * Copyright 2023 Google LLC.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */class D2{constructor(t,e){this.variableNames=["dy"],this.uniforms=`effectiveXSize : vec2<i32>, effectiveYSize : vec2<i32>, invHeightScale : f32, invWidthScale : f32,
 ...
 * limitations under the License.
 * =============================================================================
 */function T2(i){const{inputs:t,backend:e,attrs:r}=i,{images:o,dy:n}=t,{alignCorners:a}=r,[,u,c]=o.shape,[,h,p]=n.shape,d=[a&&h>1?u-1:u,a&&p>1?c-1:c],m=[a&&h>1?h-1:h,a&&p>1?p-1:p],x=d[0]/m[0],y=d[1]/m[1],w=1/x,b=1/y,I=Math.ceil(w)*2+2,R=Math.ceil(b)*2+2,P=new D2(o.shape,a),A=[{type:"int32",data:d},{type:"int32",data:m},{type:"float32",data:[w]},{type:"float32",data:[b]},{type:"int32",data:[I]},{type:"int32",data:[R]}];return e.runWebGPUProgram(P,[n],n.dtype,A)}const F2={kernelName:Fc,backendName:"webgpu",kernelFunc:T2};/**
 * @license
 * Copyright 2022 Google LLC.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */class E2{constructor(t){this.variableNames=["x"],this.workgroupSize=[64,1,1],this.size=!0,this.outputShape=t,this.dispatchLayout=U(this.outputShape),this.dispatch=L(this.dispatchLayout,this.outputShape,this.workgroupSize),this.uniforms=" axis : vec4<i32>,",this.shaderKey="reverse"}getUserCode(){return`
 ...
 * limitations under the License.
 * =============================================================================
 */function _2(i){const{inputs:t,backend:e,attrs:r}=i,{x:o}=t,{dims:n}=r,a=o.shape.length;if(a===0)return Ee({inputs:{x:o},backend:e});const u=o.shape,c=[1,1,1,1];u.forEach((b,I)=>{const R=I+4-a;c[R]=b});const h=ft(n,o.shape),p=[0,0,0,0];h.forEach(b=>{const I=b+4-a;p[I]=1});const d=[{type:"int32",data:p}],m=H({inputs:{x:o},backend:e,attrs:{shape:c}}),x=new E2(c),y=e.runWebGPUProgram(x,[m],m.dtype,d);e.disposeData(m.dataId);const w=H({inputs:{x:y},backend:e,attrs:{shape:u}});return e.disposeData(y.dataId),w}const z2={kernelName:Ec,backendName:"webgpu",kernelFunc:_2};/**
 * @license
 * Copyright 2021 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */class M2{constructor(t,e){this.outputShape=[],this.variableNames=["x"],this.workgroupSize=[64,1,1],this.size=!0,this.outputShape=t,this.dispatchLayout=U(this.outputShape),this.dispatch=L(this.dispatchLayout,this.outputShape,this.workgroupSize),this.uniforms=`centerX : f32, centerY : f32, sinRadians : f32,
 ...
 * limitations under the License.
 * =============================================================================
 */const L2={kernelName:_c,backendName:"webgpu",kernelFunc:({inputs:i,attrs:t,backend:e})=>{const{image:r}=i,{radians:o,fillValue:n,center:a}=t,u=e,c=new M2(r.shape,n),[h,p]=zc(a,r.shape[1],r.shape[2]),d=[{type:"float32",data:[h]},{type:"float32",data:[p]},{type:"float32",data:[Math.sin(o)]},{type:"float32",data:[Math.cos(o)]}];return typeof n=="number"?d.push({type:"float32",data:[Number.parseFloat(n.toFixed(2))]}):d.push({type:"float32",data:n}),u.runWebGPUProgram(c,[r],r.dtype,d)}};/**
 * @license
 * Copyright 2022 Google LLC.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */const O2=se({opType:z.ROUND}),B2={kernelName:Mc,backendName:"webgpu",kernelFunc:O2};/**
 * @license
 * Copyright 2021 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */const W2=se({opType:z.RSQRT,cpuKernelImpl:tf}),U2={kernelName:Lc,backendName:"webgpu",kernelFunc:W2};/**
 * @license
 * Copyright 2021 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function j2(i){const{inputs:t,backend:e,attrs:r}=i,{sortedSequence:o,values:n}=t,{side:a}=r,u=new H2([n.shape[0],n.shape[1]],a),c=[{type:"int32",data:[o.shape[1]]}];return e.runWebGPUProgram(u,[o,n],"int32",c)}const X2={kernelName:Bc,backendName:"webgpu",kernelFunc:j2};/**
 * @license
 * Copyright 2019 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function Y2(i){const{inputs:t,backend:e}=i,{condition:r,t:o,e:n}=t,a=new K2(r.shape.length,o.shape,o.shape.length);return e.runWebGPUProgram(a,[r,o,n],Jt(o.dtype,n.dtype))}const q2={kernelName:Wc,backendName:"webgpu",kernelFunc:Y2};/**
 * @license
 * Copyright 2022 Google LLC.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */const Q2=se({opType:z.SELU}),Z2={kernelName:Uc,backendName:"webgpu",kernelFunc:Q2};/**
 * @license
 * Copyright 2021 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */const J2=se({opType:z.SIGMOID}),ew={kernelName:Vc,backendName:"webgpu",kernelFunc:J2};/**
 * @license
 * Copyright 2022 Google LLC.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */const tw=se({opType:z.SIGN}),iw={kernelName:Gc,backendName:"webgpu",kernelFunc:tw};/**
 * @license
 * Copyright 2021 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */const rw=se({opType:z.SIN}),ow={kernelName:Hc,backendName:"webgpu",kernelFunc:rw};/**
 * @license
 * Copyright 2021 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */const sw=se({opType:z.SINH}),nw={kernelName:jc,backendName:"webgpu",kernelFunc:sw};/**
 * @license
 * Copyright 2022 Google LLC.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */const aw=se({opType:z.SOFTPLUS}),uw={kernelName:Xc,backendName:"webgpu",kernelFunc:aw};/**
 * @license
 * Copyright 2023 Google LLC.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */const cw=i=>{const{inputs:t,backend:e,attrs:r}=i,{x:o}=t,{blockShape:n,paddings:a}=r;ne(o.shape.length<=4,()=>"spaceToBatchND for rank > 4 with a WebGPU backend not implemented yet");const u=n.reduce((R,P)=>R*P),c=[[0,0]];c.push(...a);for(let R=1+n.length;R<o.shape.length;++R)c.push([0,0]);const h=c.map((R,P)=>R[0]+o.shape[P]+R[1]),p=_s(h,n,u,!1),d=zs(p.length,n.length,!1),m=Ms(h,n,u,!1),x=Zt(h),y=new lw(o.shape,h,c,p,d,x.length),w=[{type:"int32",data:p},{type:"int32",data:x}];c.map(R=>w.push({type:"int32",data:[R[0],R[1]]}));const b=e.runWebGPUProgram(y,[o],o.dtype,w),I=H({inputs:{x:b},backend:e,attrs:{shape:m}});return e.disposeData(b.dataId),I},hw={kernelName:Kc,backendName:"webgpu",kernelFunc:cw};/**
 * @license
 * Copyright 2023 Google LLC.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 */class dw{constructor(t,e,r){this.variableNames=["input","indices","segmentIds"],this.outputShape=[],this.uniforms="segmentSize : i32, sparseSize : i32,",this.workgroupSize=[64,1,1],this.atomic=!0,this.outputShape=t,this.type=r,this.dispatchLayout=U([e]),this.dispatch=L(this.dispatchLayout,[e],this.workgroupSize),this.shaderKey="sparseSegmentSum"}getUserCode(){return`
  ...
  `}}class pw{constructor(t,e){this.variableNames=["segmentIds"],this.outputShape=[],this.workgroupSize=[64,1,1],this.atomic=!0,this.outputShape=[t],this.dispatchLayout=U(e),this.dispatch=L(this.dispatchLayout,e,this.workgroupSize),this.shaderKey="sparseSegmentIdCountProgram"}getUserCode(){return`
    ${M("index")} {
 ...
 * limitations under the License.
 * =============================================================================
 */function mn(i,t,e,r=!1,o){const a=J(i.shape)/i.shape[0],u=i.dtype,c=J(t.shape),h=o.readSync(e.dataId),d=c>0?h[c-1]+1:0;let m;const x=i.shape.slice();x[0]=d;const y=c*a,w=$e({backend:o,attrs:{shape:x,value:0,dtype:u}});m=new dw(x,y,u);let b=[{type:"int32",data:[a]},{type:"int32",data:[y]}];const I=o.runWebGPUProgram(m,[i,t,e],u,b,w);if(r)return I;const R=$e({backend:o,attrs:{shape:[d],value:0,dtype:"int32"}});m=new pw(d,e.shape);const P=o.runWebGPUProgram(m,[e],"int32",null,R),A=$e({backend:o,attrs:{shape:x,value:0,dtype:u}});m=new fw(x,u),b=[{type:"int32",data:[a]}];const N=o.runWebGPUProgram(m,[I,P],u,b,A);return o.disposeData(I.dataId),o.disposeData(P.dataId),N}/**
 * @license
 * Copyright 2023 Google LLC.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function mw(i){const{inputs:t,backend:e}=i,{data:r,indices:o,segmentIds:n}=t;return mn(r,o,n,!1,e)}const gw={kernelName:Yc,backendName:"webgpu",kernelFunc:mw};/**
 * @license
 * Copyright 2023 Google LLC.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function xw(i){const{inputs:t,backend:e}=i,{data:r,indices:o,segmentIds:n}=t;return mn(r,o,n,!0,e)}const yw={kernelName:qc,backendName:"webgpu",kernelFunc:xw};/**
 * @license
 * Copyright 2021 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */class ww{constructor(t,e){this.variableNames=["A"],this.workgroupSize=[64,1,1],this.size=!0;const r=new Array(t.length);for(let o=0;o<r.length;o++)r[o]=t[o]*e[o];this.outputShape=r,this.dispatchLayout=U(this.outputShape),this.dispatch=L(this.dispatchLayout,this.outputShape,this.workgroupSize),this.rank=this.outputShape.length,this.shaderKey="tile"}getUserCode(){const t=vw(this.rank,"uniforms.");return`
      ${M("index")} {
        if (index < uniforms.size) {
          let resRC = getCoordsFromIndex(index);
    ...
    `}}function vw(i,t=""){if(i>=5)throw Error(`Tile for rank ${i} is not yet supported`);if(i===1)return`(resRC % ${t}aShape)`;const e=["resRC.x","resRC.y","resRC.z","resRC.w"],r=[];for(let o=0;o<i;o++)r.push(`(${e[o]} % ${t}aShape[${o}])`);return r.join()}/**
 * @license
 * Copyright 2021 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function kw(i){const{inputs:t,backend:e,attrs:r}=i,{x:o}=t,{numOrSizeSplits:n,axis:a}=r,u=ft(a,o.shape)[0],c=th(o,n,u),h=o.shape.length,p=new Array(h).fill(0),d=o.shape.slice();return c.map(m=>{const x=[...d];x[u]=m;const y=_t({inputs:{x:o},backend:e,attrs:{begin:p,size:x}});return p[u]+=m,y})}const Iw={kernelName:eh,backendName:"webgpu",kernelFunc:kw};/**
 * @license
 * Copyright 2021 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */const Rw=se({opType:z.SQRT}),Pw={kernelName:ih,backendName:"webgpu",kernelFunc:Rw};/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */const Aw={kernelName:rh,backendName:"webgpu",kernelFunc:({inputs:i,backend:t})=>{const{x:e}=i,r=t,o=new Et(e.shape,z.SQUARE);return r.runWebGPUProgram(o,[e],e.dtype)}};/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */const $w=ye({opType:K.SQUARED_DIFFERENCE}),Nw={kernelName:oh,backendName:"webgpu",kernelFunc:$w};/**
 * @license
 * Copyright 2022 Google LLC.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function Dw({inputs:i,attrs:t,backend:e}){const{x:r}=i,o=new Et(r.shape,z.STEP,"stepAlpha : f32,"),n=[{type:"float32",data:[t.alpha]}];return e.runWebGPUProgram(o,[r],r.dtype,n)}const Tw={kernelName:sh,backendName:"webgpu",kernelFunc:Dw};/**
 * @license
 * Copyright 2019 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function zw(i){const{inputs:t,backend:e,attrs:r}=i,{separator:o,nGramWidths:n,leftPad:a,rightPad:u,padWidth:c,preserveShortSequences:h}=r,{data:p,dataSplits:d}=t,m=e.readSync(p.dataId),x=e.readSync(d.dataId),[y,w]=af(m,x,o,n,a,u,c,h);return[e.makeTensorInfo([y.length],"string",y),e.makeTensorInfo(d.shape,"int32",w)]}const Mw={kernelName:lh,backendName:"webgpu",kernelFunc:zw};/**
 * @license
 * Copyright 2021 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */const Lw=ye({opType:K.SUB,cpuKernelImpl:uf,supportsComplex:!0}),Ow={kernelName:ch,backendName:"webgpu",kernelFunc:Lw};/**
 * @license
 * Copyright 2022 Google LLC.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */const Bw=se({opType:z.TAN}),Ww={kernelName:hh,backendName:"webgpu",kernelFunc:Bw};/**
 * @license
 * Copyright 2021 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */const Uw=se({opType:z.TANH}),Vw={kernelName:dh,backendName:"webgpu",kernelFunc:Uw};/**
 * @license
 * Copyright 2023 Google LLC.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */class jw{constructor(t){this.variableNames=["x","indices"],this.workgroupSize=[256,1,1],this.size=!0,this.outputShape=t,this.dispatchLayout=U(this.outputShape),this.dispatch=L(this.dispatchLayout,this.outputShape,this.workgroupSize),this.uniforms=`inputSize : i32, firstPass : i32, negativeInf : f32,
      ...
      `}}class Xw{constructor(t){this.variableNames=["x","indices"],this.workgroupSize=[256,1,1],this.size=!0,this.outputShape=t,this.dispatchLayout=U(this.outputShape),this.dispatch=L(this.dispatchLayout,this.outputShape,this.workgroupSize),this.uniforms="inputSize : i32, firstPass : i32, k : i32,",this.shaderKey="merge"}getUserCode(){return`
        ${M("index")} {
          if (index < uniforms.size) {
            let outC = getCoordsFromIndex(index);
            let batch = outC[0];
 ...
 * limitations under the License.
 * =============================================================================
 */function Ct(i,t){t!==null&&i.disposeData(t.dataId)}function is(i){let t=1;for(;t<i;)t*=2;return t}function Kw(i){const{inputs:t,backend:e,attrs:r}=i,{x:o}=t,{k:n,sorted:a}=r,u=o.shape,c=u[u.length-1];if(e.shouldExecuteOnCPU([o])){const N=e.readSync(o.dataId),[D,T]=cf(N,u,o.dtype,n,a);return[e.makeTensorInfo(D.shape,D.dtype,D.values),e.makeTensorInfo(T.shape,T.dtype,T.values)]}if(n===0)return u[u.length-1]=0,[e.makeTensorInfo(u,o.dtype,[]),e.makeTensorInfo(u,"int32",[])];if(c===1)return[o,$e({attrs:{shape:u,dtype:"int32",value:0},backend:e})];const p=J(u)/c,d=H({inputs:{x:o},attrs:{shape:[p,c]},backend:e}),m=is(n),x=is(c);let y=null;const w=()=>y===null?[d,d]:[d,y],b=(N,D,T)=>{const E=w(),F=new jw(T),B=[{type:"int32",data:[c]},{type:"int32",data:[y===null?1:0]},{type:"float32",data:[Number.NEGATIVE_INFINITY]},{type:"int32",data:[N]},{type:"int32",data:[D]}],X=y;y=e.runWebGPUProgram(F,E,"int32",B),Ct(e,X)};for(let N=1;N<m;N*=2){const D=N*2;for(let T=N;T>=1;T/=2)b(D,T,[p,x])}for(let N=x;N>m;N/=2){const D=w(),T=new Xw([p,N/2]),F=[{type:"int32",data:[c]},{type:"int32",data:[y===null?1:0]},{type:"int32",data:[m]}],W=y;y=e.runWebGPUProgram(T,D,"int32",F),Ct(e,W);const B=m/2,X=B*2;for(let G=B;G>=1;G/=2)b(X,G,y.shape)}let I=y;y=_t({inputs:{x:y},backend:e,attrs:{begin:0,size:[p,n]}}),Ct(e,I);let R=cn({inputs:{x:d,indices:y},backend:e,attrs:{axis:1,batchDims:1}});Ct(e,d);const P=u.slice(0,-1);P.push(n),I=y,y=H({inputs:{x:y},attrs:{shape:P},backend:e}),Ct(e,I);const A=R;return R=H({inputs:{x:R},attrs:{shape:P},backend:e}),Ct(e,A),[R,y]}const Yw={kernelName:fh,backendName:"webgpu",kernelFunc:Kw};/**
 * @license
 * Copyright 2021 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function iv(i){const{inputs:t,backend:e,attrs:r}=i,{x:o,segmentIds:n}=t,{numSegments:a}=r,u=o.shape.length,c=[];let h=0;const p=ai([h],u);let d=o;p!=null&&(d=Xe({inputs:{x:o},backend:e,attrs:{perm:p}}),c.push(d),h=ui(1,u)[0]);const m=yh(d.shape,h,a),x=J([d.shape[h]]),y=H({inputs:{x:d},backend:e,attrs:{shape:[-1,x]}});c.push(y);const w=o.dtype,b=[y.shape[0],a],I=$e({backend:e,attrs:{shape:b,value:0,dtype:w}}),R=new tv(y.shape,b,w),P=[{type:"int32",data:[a]},{type:"int32",data:[J(y.shape)]}],A=e.runWebGPUProgram(R,[y,n],w,P,I),N=H({inputs:{x:A},backend:e,attrs:{shape:m}});c.push(A);let D=N;if(p!=null){c.push(N);const T=Os(p);D=Xe({inputs:{x:D},backend:e,attrs:{perm:T}})}return c.forEach(T=>e.disposeData(T.dataId)),D}const rv={kernelName:xh,backendName:"webgpu",kernelFunc:iv};/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */const ov=[Ap,pf,mf,xf,wf,bf,$f,Df,Ff,_f,Mf,Of,Wf,Vf,Hf,qf,Zf,im,om,nm,hm,mm,ym,bm,km,Am,Np,Dm,_m,Vm,Ym,Jm,ig,og,ng,ug,cg,pg,mg,xg,wg,bg,$g,Dg,Ig,Eg,Mg,Wg,Vg,jg,qg,Zg,ex,ix,ox,nx,ax,lx,hx,Ip,px,wx,mx,xx,bx,kx,Rx,$x,Tx,Ex,zx,$p,Lx,Fm,Bx,Ux,Gx,jx,Kx,qx,Jx,ry,ty,sy,ay,ly,py,gy,Xf,yy,vy,Ay,by,Ry,Ny,Kf,Ty,Ey,zy,Ly,Vy,Xg,Hy,Xy,Yy,wm,Zy,e2,i2,s2,a2,l2,h2,p2,vm,m2,x2,w2,C2,Rp,k2,P2,N2,F2,z2,L2,B2,U2,G2,X2,q2,Z2,ew,iw,ow,nw,lm,Tw,_w,Mw,Wy,uw,hw,gw,yw,Sw,Iw,Pw,Aw,Nw,Ow,Kg,Ww,Vw,Hw,Cw,Yw,Zw,If,ev,rv,Jy];for(const i of ov)wh(i);/**
    * @license
